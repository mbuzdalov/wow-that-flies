  ...
  def apply(props: BasicProperties): Unit =
    ...
    val allGraphics = GraphicsConsumer.compose(
      ...
      TextMessage("However, the more interventions you do,",
        msgCF, width * 0.5f, height * 0.4f + msgStep * 5f, HA.Center, VA.Center)
        .enabledBetween(38, 42),
      TextMessage("the less time is left for tuning,",
        msgCF, width * 0.5f, height * 0.4f + msgStep * 6f, HA.Center, VA.Center)
        .enabledBetween(38, 42),
      TextMessage("so this is a very ad-hoc activity.",
        msgCF, width * 0.5f, height * 0.4f + msgStep * 7f, HA.Center, VA.Center)
        .enabledBetween(38, 42),
