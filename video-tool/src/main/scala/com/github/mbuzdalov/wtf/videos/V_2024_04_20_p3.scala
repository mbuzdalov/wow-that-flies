  ...
  def apply(props: BasicProperties): Unit =
    ...
    val allGraphics = GraphicsConsumer.compose(sticks, rollPlot, pitchPlot,
      ...
      TextMessage("Ugh, that was a terrible one!",
        msgCF, width * 0.5f, height * 0.25f,
        HA.Center, VA.Center, 60, 65),
      TextMessage("O HAI!",
        msgCF, width * 0.5f, height * 0.85f,
        HA.Center, VA.Center, 80, 84),
      TextMessage("O HAI AGAIN!",
        msgCF, width * 0.5f, height * 0.85f,
        HA.Center, VA.Center, 136, 140),
      TextMessage("This altogether was the first outdoor session",
        msgCF, width * 0.5f, height * 0.4f,
        HA.Center, VA.Center, 161, 169),
