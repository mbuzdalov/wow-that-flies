  ...
  def apply(props: BasicProperties): Unit =
    ...
    val allGraphics = GraphicsConsumer.compose(sticks, rollPlot, pitchPlot,
      ...
      TextMessage("It's strange, but let's test it.",
        msgCF, width * 0.5f, height * 0.2f + msgStep * 3f, HA.Center, VA.Center)
        .enabledBetween(2, 8),
      ...
      TextMessage("Let's try again...",
        msgCF, width * 0.5f, height * 0.7f + msgStep * 2f, HA.Center, VA.Center)
        .enabledBetween(6, 8),
